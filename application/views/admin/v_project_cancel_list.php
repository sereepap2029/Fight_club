                     ...
                     <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">All Project</div>
                            </div>
                                            ...
                                            foreach ($project_list as $key => $value) {
                                             ...
                                             <tr>
                                                  ...
                                                  <td style="word-wrap: normal;min-width:400px;">
                                                    <a href="<? echo site_url('all/project_detail/'.$value->project_id)?>" class=""><?=$value->project_name?><i class=" icon-pencil"></i></a>
                                                    <br>
                                                          ...
                                                          <tr>
                                                            ...
                                                            foreach ($oc_bil as $oc_bil_k => $oc_bil_v) {
                                                              if ($oc_bil_v->collected=="y") {
                                                                ...
                                                                $oc_sum_billed+=(int)$oc_bil_v->amount;
                                                              }                                                      
                                                            }
                                                            ?>
                                                            </td>
                                                  ...
                                                  $manager=$ci->m_user->get_user_by_login_name($value->project_cs);
                                                    ?>
                                                    <a href="<? echo site_url('all/project_detail/'.$value->project_id)?>" class=""><?=$manager->nickname?><i class=" icon-pencil"></i></a><br>
                                                  <br>    
                                                  <a class="btn btn-danger btn-xs" href="javascript:approvol('<? echo site_url('admin/delete_project/'.$value->project_id)?>')">Delete</a>
                                                  <br>            
