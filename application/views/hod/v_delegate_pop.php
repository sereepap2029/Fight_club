            ...
            <div class="row-fluid">
                ...
                <div class="block">
                    <div class="navbar navbar-inner block-header">
                        <div class="muted pull-left">Delegate Task:<?=$task->task?>  || Available Budget:<?=$task->approve_budget?> </div>
                    </div>
...
function close_fancy() {
  ...
  $.ajax({
                method: "POST",
                url: "<?php echo site_url("hod/delegate_action"); ?>",
                data: "save=<?=$task->r_id?>&project_id=<?=$project_id?>&"+resource_usn+"&"+resource_usn_old+"&"+id_old+"&"+del_list
            })
            .done(function(data) {
              if (data['flag']=="OK") {
