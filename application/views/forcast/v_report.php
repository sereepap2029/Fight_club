                                   ...
                                   <div class="table-toolbar">
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="h1">
                                                <td colspan="3">Target Billing (OC)</td>
                                                <?
                                                $current_time=$start_time;
                                                    $cur_month=1000;
                                                    $month_amount=0;
...
///////////////////////////////////////////////////////// Actual Bill Section //////////////////////////////
                                            ...
                                            <tr class="h1">
                                                <td colspan="3">Actual Billing</td>
                                                <?
                                                $current_time=$start_time;
                                                    $cur_month=1000;
                                                    $month_amount=0;
        ...
        function search(){
          ...
          $(myform).html('<input type="text" name="start_time" value="'+$("#project_start").val()+'"><input type="text" name="end_time" value="'+$("#project_end").val()+'"><input type="text" name="business_unit_id" value="'+$("#business_unit_id").val()+'"><input type="text" name="mode" value="'+$("#mode").val()+'"><input type="text" name="account_unit_id" value="'+$("#account_unit_id").val()+'">')
