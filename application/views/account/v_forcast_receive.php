                     ...
                     <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">ประมาณการรับเงิน</div>
                            </div>
...
///////////////////////////////////////////////////////// Actual Bill Section //////////////////////////////
        ...
        function search(){
          ...
          $(myform).attr("action","<?=site_url("account/report_forcast_receive/")?>");   
        ...
        function export_forcast(){
          myform = document.createElement("form");
          $(myform).attr("action","<?=site_url("account/forcest_receive_excel/")?>");   
          $(myform).attr("method","post");
          $(myform).html('<input type="text" name="start_time" value="'+$("#project_start").val()+'"><input type="text" name="end_time" value="'+$("#project_end").val()+'"><input type="text" name="business_unit_id" value="'+$("#business_unit_id").val()+'">')
          myform.submit();
          $(myform).remove();
