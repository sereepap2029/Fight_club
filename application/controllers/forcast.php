...
class Forcast extends CI_Controller {
	...
	public function index()
	{
        ...
        $array_user=$this->m_user->change_node_user_to_array($all_user_under);
            ...
            $data_view['dat']=$this->m_forcast->get_all_forcast($this->user_data->username,"no","no","all",$where);
        $this->load->view('v_header', $data_head);
        $this->load->view('forcast/v_list',$data_view);
        $this->load->view('v_footer', $data_foot);
		
	}
    public function delete_forcast() {
    ...
    public function report()
    {
        ...
        if (isset($_POST['account_unit_id'])) {
            $data_view['account_unit_id']=$_POST['account_unit_id'];
        }else{
            $data_view['account_unit_id']="all";
        }
        if (isset($_POST['mode'])) {
        ...
        if (isset($this->user_data->prem['cs'])&&(!isset($this->user_data->prem['admin'])&&!isset($this->user_data->prem['account'])&&!isset($this->user_data->prem['csd']))) {
            ...
            $data_view['forcast_report']=$this->m_forcast->get_forcast_report($data_view['start_time'],$data_view['end_carlendar_unix'],$data_view['bus_unit'],$array_user,$data_view['mode'],$data_view['account_unit_id']);
            $data_view['pce_report']=$this->m_forcast->get_forcast_pce_report($data_view['start_time'],$data_view['end_carlendar_unix'],$data_view['bus_unit'],$array_user,$data_view['mode'],$data_view['account_unit_id']);
            $data_view['target_bill_report']=$this->m_forcast->get_forcast_target_bill_report($data_view['start_time'],$data_view['end_carlendar_unix'],$data_view['bus_unit'],$array_user,$data_view['mode'],$data_view['account_unit_id']);
            $data_view['actual_bill_report']=$this->m_forcast->get_forcast_actual_bill_report($data_view['start_time'],$data_view['end_carlendar_unix'],$data_view['bus_unit'],$array_user,$data_view['mode'],$data_view['account_unit_id']);
        }else{
            $data_view['forcast_report']=$this->m_forcast->get_forcast_report($data_view['start_time'],$data_view['end_carlendar_unix'],$data_view['bus_unit'],$multi_usn,$data_view['mode'],$data_view['account_unit_id']);
            $data_view['pce_report']=$this->m_forcast->get_forcast_pce_report($data_view['start_time'],$data_view['end_carlendar_unix'],$data_view['bus_unit'],$multi_usn,$data_view['mode'],$data_view['account_unit_id']);
            $data_view['target_bill_report']=$this->m_forcast->get_forcast_target_bill_report($data_view['start_time'],$data_view['end_carlendar_unix'],$data_view['bus_unit'],$multi_usn,$data_view['mode'],$data_view['account_unit_id']);
            $data_view['actual_bill_report']=$this->m_forcast->get_forcast_actual_bill_report($data_view['start_time'],$data_view['end_carlendar_unix'],$data_view['bus_unit'],$multi_usn,$data_view['mode'],$data_view['account_unit_id']);
        }
    ...
    public function forcest_excel()
    {
        ...
        $multi_usn = array("all" => "all");
        $forcast_report=$this->m_forcast->get_forcast_report($start_time,$end_carlendar_unix,$bus_unit,$multi_usn,1,$account_unit_id);
        $pce_report=$this->m_forcast->get_forcast_pce_report($start_time,$end_carlendar_unix,$bus_unit,$multi_usn,1,$account_unit_id);
        $target_bill_report=$this->m_forcast->get_forcast_target_bill_report($start_time,$end_carlendar_unix,$bus_unit,$multi_usn,1,$account_unit_id);
        $actual_bill_report=$this->m_forcast->get_forcast_actual_bill_report($start_time,$end_carlendar_unix,$bus_unit,$multi_usn,1,$account_unit_id);
        if (isset($this->user_data->prem['cs'])&&(!isset($this->user_data->prem['admin'])&&!isset($this->user_data->prem['account'])&&!isset($this->user_data->prem['csd']))) {
            $all_user_under=$this->m_user->get_all_user_by_super_usn_all_lv($this->user_data->username,$this->user_data->username);
            $array_user=$this->m_user->change_node_user_to_array($all_user_under);
            $array_user[$this->user_data->username]=$this->user_data->username;
            $forcast_report=$this->m_forcast->get_forcast_report($start_time,$end_carlendar_unix,$bus_unit,$array_user,1,$account_unit_id);
            $pce_report=$this->m_forcast->get_forcast_pce_report($start_time,$end_carlendar_unix,$bus_unit,$array_user,1,$account_unit_id);
            $target_bill_report=$this->m_forcast->get_forcast_target_bill_report($start_time,$end_carlendar_unix,$bus_unit,$array_user,1,$account_unit_id);
            $actual_bill_report=$this->m_forcast->get_forcast_actual_bill_report($start_time,$end_carlendar_unix,$bus_unit,$array_user,1,$account_unit_id);
        }
        /** Error reporting */
    ...
    public function forcest_excel_client_mode()
    {
        ...
        $forcast_report=$this->m_forcast->get_forcast_report($start_time,$end_carlendar_unix,$bus_unit,$multi_usn,$mode,$account_unit_id);
        $pce_report=$this->m_forcast->get_forcast_pce_report($start_time,$end_carlendar_unix,$bus_unit,$multi_usn,$mode,$account_unit_id);
        $target_bill_report=$this->m_forcast->get_forcast_target_bill_report($start_time,$end_carlendar_unix,$bus_unit,$multi_usn,$mode,$account_unit_id);
        $actual_bill_report=$this->m_forcast->get_forcast_actual_bill_report($start_time,$end_carlendar_unix,$bus_unit,$multi_usn,$mode,$account_unit_id);
        if (isset($this->user_data->prem['cs'])&&(!isset($this->user_data->prem['admin'])&&!isset($this->user_data->prem['account'])&&!isset($this->user_data->prem['csd']))) {
            $all_user_under=$this->m_user->get_all_user_by_super_usn_all_lv($this->user_data->username,$this->user_data->username);
            $array_user=$this->m_user->change_node_user_to_array($all_user_under);
            $array_user[$this->user_data->username]=$this->user_data->username;
            $forcast_report=$this->m_forcast->get_forcast_report($start_time,$end_carlendar_unix,$bus_unit,$array_user,$mode,$account_unit_id);
            $pce_report=$this->m_forcast->get_forcast_pce_report($start_time,$end_carlendar_unix,$bus_unit,$array_user,$mode,$account_unit_id);
            $target_bill_report=$this->m_forcast->get_forcast_target_bill_report($start_time,$end_carlendar_unix,$bus_unit,$array_user,$mode,$account_unit_id);
            $actual_bill_report=$this->m_forcast->get_forcast_actual_bill_report($start_time,$end_carlendar_unix,$bus_unit,$array_user,$mode,$account_unit_id);
        }
        /** Error reporting */
        error_reporting(E_ALL);
        ini_set('display_errors', TRUE);
