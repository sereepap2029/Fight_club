...
<style type="text/css">
    ...
    <div class="container-fluid">
                ...
                <div class="row-fluid">
                    ...
                    <div class="block">
                        <div class="navbar navbar-inner block-header">
                            <div class="muted pull-left">ปฏิทินวันลาของพนักงาน</div>
                        </div>
                                                ...
                                                for ($j=0; $j <=$num_day_in_month+7 ; $j+=7) { 
                                                    if ($j==0) {
                                                        ...
                                                        for ($m=$first_day_in_week; $m <=7 ; $m++) { 
                                                            ...
                                                            ?>
                                                            <td class="<?=$holi_class?> <?=$weekend?>" unix-time="<?=$cur_time?>" ><?=$days?></td>
                                                            <?
                                                            $days+=1;
                                                        }
                                                        ?>
        ...
        <a class="fancybox" style="display:none;" id="c_add_leave" data-fancybox-type="iframe" href="<?=site_url("hod/assign_action/1123")?>"></a>
    </div>
    <!--/.fluid-container-->
    ...
    $(document).on("click", ".set_holiday", function() {
        ...
        $("#c_add_leave").attr("href","<?=site_url('hr/pop_user_leave')?>/"+current_ele.attr("unix-time"));
        $("#c_add_leave").trigger('click'); 
