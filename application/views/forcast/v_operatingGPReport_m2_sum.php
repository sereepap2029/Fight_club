                                   ...
                                   <div class="table-toolbar">
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-striped">
                                        ...
                                        ?>
                                            <tr class="h1">
                                                ...
                                                if ($loop_num==1) {
                                                  ...
                                                  if ($mode==3) {
                                                    $str1=explode("_", $key);
                                                    ?>
                                                    <td rowspan="1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?=$company[$str1[0]]->name." ".$bu[$str1[1]]->bu_name?></td>
                                                    <?
                                                  }else{
                                                  ?>
                                                  <td rowspan="1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?=$company[$key]->name?></td>
                                                  <?
                                                  }
                                                ?>
                                                <?
                                            ...
                                            $loop_num=1;
                                            $span_row=count($target_bill_report);
...
///////////////////////////////////////////////////////// Actual Bill Section //////////////////////////////
                                            ...
                                            $loop_num=1;
                                            $span_row=count($actual_bill_report);
                        ...
                        if (isset($user_data->prem['admin'])||isset($user_data->prem['account'])||isset($user_data->prem['csd'])||isset($user_data->prem['fc'])) {
                            ?>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-striped">
                                        ...
                                        <?
                                            $loop_num=1;
                                            $span_row=count($forcast_report_cash);
                                        ...
                                        ?>
                                            ...
                                            $loop_num=1;
                                            $span_row=count($pce_report_cash);
                                            ...
                                            $loop_num=1;
                                            $span_row=count($target_bill_report_cash);
...
///////////////////////////////////////////////////////// Actual Bill Section //////////////////////////////
                                            ...
                                            $loop_num=1;
                                            $span_row=count($actual_bill_report_cash);
