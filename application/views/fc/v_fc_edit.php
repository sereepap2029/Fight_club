                    ...
                    <div class="block-content collapse in">
                        <form id="pro_add_form" class="form-horizontal" method="post" action="<?echo site_url('project/edit_project_action');?>">
                                                ...
                                                <td></td><td colspan="2" style="text-align: left;">
                                                   ...
                                                   if ($pce->csd_sign_status=="y") {                                                    
                                                    ...
                                                    if ($pce->fc_sign_status=="y") {                                                    
                                                        ...
                                                        ?>
                                                        <a id="fc_a_<?echo $cur_time;?>" class="btn fancybox btn-warning" data-fancybox-type="iframe" href="<?echo site_url("project/approve_pce_view/".$cur_time."/fc");?>" >Waiting for FC Approve</a>
                                                        <?
                                                    }
                                                    ?>
                                                </td></tr>
                                ...
                                ?>
                                  ...
                                  <div class="span12 no-margin-left">
                                  <a href="<?=site_url("fc")?>" class="btn btn-info">BACK</a>
                                </div>
                            </fieldset>
                        </form>
