                     ...
                     <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Position to Service Structure</div>
                            </div>
                                ...
                                <div class="span12">
                                    ...
                                    foreach ($position_list as $key => $value) {
                                      ?>
                                       ...
                                       <tbody>
                                        <tr>
                                           <td id="key1_<?=$value->id?>" class="head" colspan="<?=count($value->service_list)?>"><?=$value->name?></td>
                                         </tr>
                                         <tr>
                                           <?
                                           foreach ($value->service_list as $key2 => $value2) {
                                             ?>
                                             <td id="key2_<?=$value->id?>_<?=$value2->hour_rate_id?>"><?
                                             echo $hour_rate_list[$value2->hour_rate_id]->name;
                                             ?></td>
                                             <?
                                           }
                                           if (count($value->service_list)==0) {
                                             ?>
         ...
         foreach ($position_list as $key => $value) {
           foreach ($value->service_list as $key2 => $value2) {
            ...
            jsPlumb.connect({
              ...
              target:"key2_<?=$value->id?>_<?=$value2->hour_rate_id?>",
              endpoint:"Dot",
