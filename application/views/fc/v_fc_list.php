            ...
            <div class="row-fluid">
                ...
                <div class="block">
                    <div class="navbar navbar-inner block-header">
                        <div class="muted pull-left">FC Pending Approval</div>
                    </div>
                              ...
                              <!-- dropdown -->
                                <div class="right_ul">
                                    ...
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li><a href="#tab_two" data-toggle="tab">OC</a></li>
                                    </ul>
                                    <div id="myTabContent" class="tab-content">
                                        <div class="tab-pane active in" id="tab_one">
                                            <fieldset>
                                                <div class="table-toolbar">
                                                <a href="javascript:fc_bat_app();"><button class="btn btn-info">Approve By Checkbox</button></a>
                                                </div>
                                                <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example2">
                                                    ...
                                                    <tbody>
                                                        <? $countnum=0;foreach ($project_list as $key=> $value) { $countnum+=1;
                                                         ...
                                                         <tr>
                                                              ...
                                                              <td style="word-wrap: normal;min-width:400px;">
                                                                <a href="<? echo site_url('fc/edit_fc/'.$value->project_id)?>" class=""><?=$value->project_name?><i class=" icon-pencil"></i></a>
                                                                <br>
                                                      ...
                                                      $lenght_time=1;
                                                              ...
                                                              $manager=$ci->m_user->get_user_by_login_name($value->project_cs);
                                                                ?>
                                                                <a href="<? echo site_url('fc/edit_fc/'.$value->project_id)?>" class=""><?=$manager->nickname?><i class=" icon-pencil"></i></a><br>                                                                
                                                                <a href="javascript:approvol('<? echo site_url('fc/approve_fc/'.$value->project_id)?>');" class="btn btn-info btn-xs">Approve</a>
                                                              <br>                
                                        ...
                                        <div class="tab-pane fade" id="tab_two">
                                            <div class="table-toolbar">
                                               <a href="javascript:fc_bat_app_oc();"><button class="btn btn-info">Approve By Checkbox</button></a>
                                            </div>
                                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example2">
                                                    <thead>
                                                        <tr>
                                                    ...
                                                    <tbody>
                                                        <? $countnum=0;foreach ($project_list_oc as $key=> $value) { $countnum+=1;
                                                          $company=$ci->m_company->get_company_by_id($value->project_client);
                                                          $company_bu=$ci->m_company->get_bu_by_id($value->project_bu);
                                                          $oc_list=$ci->m_oc->get_all_oc_by_project_id($value->project_id);
                                                          $pce_list=$ci->m_pce->get_all_pce_by_project_id($value->project_id);
                                                         ...
                                                         ?>
                                                         <tr>
                                                              <td><? echo $countnum; ?> <input type="checkbox" name="app_bat_oc[]" value="<?=$value->project_id?>"></td>
                                                              <td style="word-wrap: normal;min-width:400px;">
                                                                <a href="<? echo site_url('fc/edit_fc_oc/'.$value->project_id)?>" class=""><?=$value->project_name?><i class=" icon-pencil"></i></a>
                                                                <br>
                                                              <? echo $company->name." ".$company_bu->bu_name;
                                                              ?><br>
                                                              <div id="Modal_<?=$value->project_id?>" class="modal hide in" aria-hidden="false">
                                                      ...
                                                      $lenght_time=1;
                                                              ...
                                                              $manager=$ci->m_user->get_user_by_login_name($value->project_cs);
                                                                ?>
                                                                <a href="<? echo site_url('fc/edit_fc_oc/'.$value->project_id)?>" class=""><?=$manager->nickname?><i class=" icon-pencil"></i></a><br>                                                                
                                                                <a href="javascript:approvol('<? echo site_url('fc/approve_fc_oc/'.$value->project_id)?>');" class="btn btn-info btn-xs">Approve</a>
                                                              <br>                
                                                                <a class="fancybox" data-fancybox-type="iframe" href="<?=site_url("project/project_note/".$value->project_id)?>">
                                                                  <img style="width:30px" class="no-margin-left" src="<?echo site_url('img/project_note.png')?>">
                                                                </a>
...
<script type="text/javascript">
    ...
    function fc_bat_app() {
      if (confirm("Confirm Approve Project")) {
        ...
        $.ajax({
                    method: "POST",
                    url: "<?php echo site_url("fc/app_bat"); ?>",
                    data: ""+app_bat
                })
                .done(function(data) {
                  if (data['flag']=="OK") {
                    alert("complete");
                    window.open("<?php echo site_url("fc"); ?>","_self")
                  }else{
                    alert(data['flag']);
                    console.log(data)
                  }
    ...
    function fc_bat_app_oc() {
      if (confirm("Confirm Approve Project")) {
        var app_bat=$("input[name='app_bat_oc[]']").serialize();
        $.ajax({
                    method: "POST",
                    url: "<?php echo site_url("fc/app_bat_oc"); ?>",
                    data: ""+app_bat
                })
                .done(function(data) {
                  if (data['flag']=="OK") {
