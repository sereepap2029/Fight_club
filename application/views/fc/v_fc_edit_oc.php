                                                ...
                                                <td></td><td colspan="2" style="text-align: left;">
                                                   ...
                                                   if ($pce->csd_sign_status=="y") {                                                    
                                                    ...
                                                    if ($pce->fc_sign_status=="y") {                                                    
                                                        ...
                                                        ?>
                                                        <a id="fc_a_<?echo $cur_time;?>" class="btn fancybox" data-fancybox-type="iframe" href="<?echo site_url("project/approve_pce_view/".$cur_time."/fc");?>" >Waiting for FC Approve </a>
                                                        <?
                                                    }
                                                    ?>
                                                </td></tr>
